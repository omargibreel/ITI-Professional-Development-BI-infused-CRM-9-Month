...
import { RouterOutlet, RouterLinkWithHref, RouterModule, RouterLinkActive } from '@angular/router';
...
import { Header } from "./components/Day5/header/header";
...
@Component({
  ...
  imports: [UpperCasePipe, LowerCasePipe, CurrencyPipe, CustomPipe, Custom, AllInOne, Home, Login, Registeration, Students, Validatorss, Header, RouterOutlet, About],// Any (Modules|Component|Pipes|Directives) needs at this component Only --> [FormsModule-ReactieFormsModule-Login-Register]
